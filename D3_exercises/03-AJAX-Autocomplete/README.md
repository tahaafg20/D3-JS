...
```bash
GET https://recode-dictionary.herokuapp.com/autocomplete/:stem
```
...
```bash
https://recode-dictionary.herokuapp.com/autocomplete/u
https://recode-dictionary.herokuapp.com/autocomplete/un
https://recode-dictionary.herokuapp.com/autocomplete/und
https://recode-dictionary.herokuapp.com/autocomplete/unde
https://recode-dictionary.herokuapp.com/autocomplete/under
etc.
```
